...
//   /**
//    * Wrapper method for getting the right to use for an existing solution. Used primarily to log
// and
//    * capture any {@link org.springframework.web.client.RestClientResponseException} that is
// returned
//    * from the CDS client.
//    *
//    * @param dataClient a {@link org.acumos.cds.client.ICommonDataServiceRestClient} object.
//    * @param request a {@link org.acumos.licensemanager.client.model.ICommonLicenseRequest}
// object.
...
//             boolean foundIt = rtuUsers.stream().anyMatch(user ->
