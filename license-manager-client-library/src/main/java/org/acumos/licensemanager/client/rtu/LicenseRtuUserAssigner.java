...
// /**
//  * LicenseRtuUserAssigner Api will create a right to use for either a solution and can be added
// for
...
//    *
//    * @param dataServiceClient a {@link org.acumos.cds.client.ICommonDataServiceRestClient}
// object.
//    */
...
//   @Override
//   public final IAssignedRtuResponse createRtu(final CreateRtuRequest request)
...
//     List<MLPRightToUse> rtus = LicenseDataUtils.getRightToUsesNoFilter(dataClient,
// searchRequest);
...
//   private void removeRtuFromUsers(CreateRtuRequest request, AssignedRtu response)
//       throws RightToUseException {
...
//   private void grantRtuToUsers(final CreateRtuRequest request, AssignedRtu response)
//       throws RightToUseException {
