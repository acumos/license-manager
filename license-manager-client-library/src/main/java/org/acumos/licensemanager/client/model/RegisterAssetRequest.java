...
public class RegisterAssetRequest {
  ...
  public UUID getLicenseProfileId() {
    return licenseProfileId;
  }
  /**
  ...
  /**
   * License Profile ID - Acumos CDS license artifact id
   *
   * @param licenseProfileId A UUID identifing the license profile artifact in CDS
   */
  public void setLicenseProfileId(UUID licenseProfileId) {
    this.licenseProfileId = licenseProfileId;
  }
   ...
   * @param licenseProfileId A UUID identifing the license profile artifact in CDS
   */
  public void setLicenseProfileId(String licenseProfileId) {
    this.licenseProfileId = UUID.fromString(licenseProfileId);
  }
}
