...
public class GetEntitledSwidTagsByUserMain {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    try {
      ...
      GetEntitledSwidTagsResponse getEntitledSwidTagsResponse =
          licenseAsset.getEntitledSwidTagsByUser(userId, action);

      List<SwidTagsWithAvailableEntitlementSwidTagsWithAvailableEntitlement> response =
          getEntitledSwidTagsResponse.getSwidTagsWithAvailableEntitlement();
