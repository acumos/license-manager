...
public class LicenseRtuVerifierTest {
  ...
  public void licenseVerifierUserOnly()
    ...
    // CreateRtuRequest createRtuRequest = new CreateRtuRequest(solutionId,
    // allowedUser.getUserId());
    // LicenseAssigner licenseCreator = new LicenseAssigner(client);
    // IAssignedRtuResponse createdRtu = licenseCreator.createRtu(createRtuRequest);
    ...
    // IAssignedRtuResponse createdRtu2CreatedRtuResponse =
    // licenseCreator.createRtu(createRtuRequest2);
  ...
  public void licenseVerifierSiteWide()
    ...
    // assertEquals(true, verifyUserRTU != null);
    // assertEquals(true,
    // verifyUserRTU.getAllowedToUse().get(LicenseAction.DOWNLOAD).booleanValue());
  ...
  public void licenseVerifierInvalidTests() throws RightToUseException {
    ...
    // // CommonDataServiceRestClientMockImpl dataClient = new MockDatabaseClient("url", "user",
    // "pass");
  ...
  public void licenseVerifierNoRequest() throws RightToUseException {
    ...
    // // CommonDataServiceRestClientMockImpl dataClient = new MockDatabaseClient("url", "user",
    // "pass");
    // LicenseVerifier licenseVerifier = new LicenseVerifier(lumServer);
