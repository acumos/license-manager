...
3. Copyright year
4. Copyright Company
5. Copyright Suffix: Such as All Rights Reserved.
6. Contact Name
6. Contact URL or place to find out how to purchase the model.
7. Contact email
8. Right to Use Required - yes or now -- if yes then a Right To Use agreement is required.
